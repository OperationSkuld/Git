...
//			$(".galleryTabBox").eq(i).css("display","block");
//			$(".galleryTabBox").eq(i).attr("class","webuploader-container");
		}
		else{	
			$(".galleryTabBox").eq(i).hide();
//			$(".galleryTabBox").eq(i).css("display","none");
//			$(".galleryTabBox").eq(i).attr("class","webuploader-element-invisible");
		}
	}
});
...
$(".galleryImgBox ul li input[type='checkbox']").on("click",function(){
	var boxLength = 5-$(".selectImgBox li .imgDelete").length,
//		checkedLength = $(".galleryImgBox ul li input[type='checkbox']:checked").length,
		objImg = $(this).parent(),
...
function gallerySelectedImg(obj){
	var boxLength = 5-$(".selectImgBox li .imgDelete").length,
		uploadLength = $(".filelist li").length,
		imgID ,
		imgUrl ;
