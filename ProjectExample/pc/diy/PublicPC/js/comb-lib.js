...
$(function() {
    $.aLert = function(c) {
        ...
        t = $.extend(!0, {},
        o, c),
        l = "<div class='J-box'><div class='title'>" + t.title + "</div><div class='button clearfix'><button type='button' class='butcall J-noClk'>取消</button><button type='button' class='J-okClk'>确定</button></div></div>";
        $("body").append(l);
        var i = $(".J-box").height(),
        n = $(window).height(),
        a = (n - i) / 2,
        e = ($(window).width() - 260) / 2;
        $(".J-box").css({
            top: a,
            left: e
        }),
        ...
        $(".J-okClk").click(function() {
            t.callback && t.callback(),
            t.clickOK && t.clickOK(),
            s()
        }),
        $(".J-noClk").click(function() {
            t.callback && t.callback(),
            t.clickCancel && t.clickCancel(),
            s()
        })
    },
    $.Error = function(c, o) {
        var o = o ? o: 1500,
        t = $(".Errormes"),
        t = $('<section class="Errormes">' + c + "</section>");
        $("body").append(t),
        t.fadeIn("fast",
        function() {
            setTimeout(function() {
    ...
    function() {
        ...
        $(window).scroll(function() {
            $(this).scrollTop() >= 150 ? c.fadeIn(300) : c.fadeOut(300)
        })
    } (),
    $("#j-chat-gotop").click(function() {
        $("body").animate({
            scrollTop: 0
        },
        300, "linear")
    }),
    $(".j-close-chat").click(function() {
        $(".qqchat-box").hide()
    }),
