	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'14px',height:'14px',borderRadius:'50%',lineHeight:'14px',right:'47.5%',bottom:'10px',fontSize:'10px',background:"#504d52",color:"#666666",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"#FFF",borderRadius:'50%',color:"#000000"}
							},
